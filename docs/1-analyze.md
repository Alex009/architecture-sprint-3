...
5. Интеграция с разными протоколами устройств (сервисы-адаптеры) - под каждый протокол устройств выделяется свой
   микросервис-адаптер, позволяющий стандартизировать работу нашей системы с разными протоколами устройств.
